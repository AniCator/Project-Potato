...
void MainMenu::OnCommand( const char *command )
{
	...
	{
		engine->ClientCmd( "map club_coopcrowd" ); //set this to 'map club_dev' when ready
	}
	...
	{
		engine->ClientCmd( "connect server.anicator.com" ); //set this to 'connect server.anicator.com' when ready
	}
